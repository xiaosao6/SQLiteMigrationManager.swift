Pod::Spec.new do |s|
  ...
  Migration manager for SQLite.swift, based on FMDBMigrationManager.
                   DESC
  s.homepage     = "https://github.com/xiaosao6/SQLiteMigrationManager.swift"
  ...
  s.source       = { :git => "https://github.com/xiaosao6/SQLiteMigrationManager.swift.git", tag: s.version.to_s, submodules: true }
